...
//                               select new { Suit = s, Rank = r };
            var startingDeck = (from s in Suits().LogQuery5("Suit Generation")
                                from r in Ranks().LogQuery5("Rank Generation")
                                select new { Suit = s, Rank = r }).LogQuery5("Starting Deck");
...
//                shuffle = shuffle.Skip(26).InterleaveSequenceWith5(shuffle.Take(26)); // インシャッフル
                ...
                */
                ...
                shuffle = shuffle.Skip(26).LogQuery5("Bottom Half")
                        .InterleaveSequenceWith5(shuffle.Take(26).LogQuery5("Top Half"))
                        .LogQuery5("Shuffle");
